    ...
    <div className="app">
      ...
      >
        <section className="hero">
          <h1 id="heroTitle">
            {birthdayReached ? (
              <>
                Happy Birthday <span className="highlight">Sahasra</span> 🎂
              </>
            ) : (
              <>
                Counting down to <span className="highlight">Sahasra's</span>{" "}
                special day 🎂
              </>
            )}
          </h1>
          <p>Just a reminder you mean a lot to me💗</p>
        </section>
      ...
      >
        ...
        <section className="final">
          <h2 className="final-message">💖 Forever Yours — Surya 💖</h2>
          <p className="final-subtitle">I'll always love you till eternity💗</p>
        </section>
      </div>
